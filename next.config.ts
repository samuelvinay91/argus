...
const ContentSecurityPolicy = `
  ...
  connect-src 'self' https://*.clerk.accounts.dev https://clerk.heyargus.ai https://clerk-telemetry.com https://img.clerk.com https://*.supabase.co wss://*.supabase.co https://argus-brain-production.up.railway.app https://argus-api.samuelvinay-kumar.workers.dev https://*.sentry.io https://www.google-analytics.com https://www.clarity.ms https://vitals.vercel-insights.com https://vercel.live https://prod.spline.design https://*.spline.design https://*.splinecdn.com https://cdnjs.cloudflare.com https://cdn.jsdelivr.net https://cdn.simpleicons.org https://models.dev ${isDev ? 'http://localhost:* ws://localhost:*' : ''};
